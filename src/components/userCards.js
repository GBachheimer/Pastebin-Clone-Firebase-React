                ...
                return (           
                    <div className = "col-sm-6 animate" key = {paste[0]} onClick = {handleCardClick}>
                        <div className = {`card text-bg-${colors[randomColor]} my-2`}>
                            <div className = "card-header" style = {{fontSize: "1rem"}}>{paste[1].pasteTitle}</div>
                            {(!paste[1].pastePassword || (user && paste[1].pasteUser === user.uid)) && <div className = "card-body" style = {{maxHeight: "15vw", overflow: "scroll"}}>
